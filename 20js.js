...
&&(x[12]!=="0")}else {return false }}).map(function(x){return "new google.maps\
...
\n<div id=\'canv'></div></body>"); }); });app.listen(process.env.PORT || 3000);